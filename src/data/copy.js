...
export const CHARACTER_CREATION = {
  ...
  classes: {
    krieger: {
      ...
      desc: 'Kein Stratege. Kein Poet. Ein Krieger — der auf Probleme zuläuft statt nachzudenken. Das hat bisher funktioniert.',
    ...
    schatten: {
      ...
      desc: 'Schnell. Präzise. Tödlich aus dem Schatten. Ob Draugr Schatten bemerken? Keine Ahnung. Versuch es.',
    ...
    magier: {
      ...
      desc: 'Jahre Runenstudium. Odin hing neun Tage am Yggdrasil. Du hattest Bücher. Immerhin — die Feuerbälle sind beeindruckend.',
